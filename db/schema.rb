...
ActiveRecord::Schema.define(version: 2018_11_22_123506) do
  ...
  create_table "coaches", force: :cascade do |t|
    ...
    t.string "id_player", default: "", null: false
    t.text "alamat", default: "", null: false
    ...
    t.index ["unlock_token"], name: "index_coaches_on_unlock_token", unique: true
  end
